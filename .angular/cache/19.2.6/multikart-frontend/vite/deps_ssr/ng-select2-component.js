...
function createScroller(config) {
  ...
  return attachScrollEvent(options).pipe((0, import_operators5.mergeMap)(() => (0, import_rxjs7.of)(calculatePoints(element, resolver))), (0, import_operators5.map)((positionStats) => toInfiniteScrollParams(scrollState.lastScrollPosition, positionStats, distance)), (0, import_operators5.tap)(({
    stats
  }) => scrollState.updateScroll(stats.scrolled, stats.totalToScroll)), (0, import_operators5.filter)(({
    fire,
    scrollDown,
    stats: {
      totalToScroll
    }
  }) => shouldTriggerEvents(config.alwaysCallback, fire, scrollState.isTriggeredScroll(totalToScroll, scrollDown))), (0, import_operators5.tap)(({
    scrollDown,
    stats: {
      totalToScroll
    }
  ...
  }), (0, import_operators5.map)(toInfiniteScrollAction));
}
function attachScrollEvent(options) {
  let obs = (0, import_rxjs7.fromEvent)(options.container, "scroll");
  if (options.throttle) {
    obs = obs.pipe((0, import_operators5.throttleTime)(options.throttle, void 0, {
      leading: true,
      trailing: true
    }));
  }
